  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4">
      <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Typing Master (A-Z)</h2>
        <div className="text-lg text-gray-600 mb-4">
          <p>Type the random letters below as quickly and accurately as possible:</p>
        </div>
        ...
        <input
          ...
          className="w-full p-3 border rounded-md mb-6 text-lg"
        />
